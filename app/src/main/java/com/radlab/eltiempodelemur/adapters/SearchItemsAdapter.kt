...
class SearchItemsAdapter(val items: List<SearchItem>, val context: Context) : RecyclerView.Adapter<SearchItemsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.name2.text = items[position].id.toString()
    }
